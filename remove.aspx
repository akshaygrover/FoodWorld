<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="remove.aspx.cs" Inherits="FoodWorld.remove" %>
                      ...
                      <div class="row control-group">
                            <div class="form-group col-xs-12 floating-label-form-group controls">
                                <label>Recipie ID</label>
                                      <asp:TextBox ID="t3" class="form-control" runat="server"  placeholder="Enter Recipie ID to Remove" ></asp:TextBox>
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                              <asp:Button ID="Button1" runat="server" OnClick="onClick" Text="Remove Recipie"  class="btn btn-success btn-lg"></asp:Button>
                            </div>
                        </div>
