<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addrecipie.aspx.cs" Inherits="FoodWorld.addrecipie" %>
                      ...
                      <div class="row control-group">
                            <div class="form-group col-xs-12 floating-label-form-group controls">
                                <label>Recipie ID</label>
                                      <asp:TextBox ID="t3" class="form-control" runat="server"  placeholder="ID" ></asp:TextBox>
                        ...
                        <div class="row control-group">
                            <div class="form-group col-xs-12 floating-label-form-group controls">
                              ...
                              --> 
                                <asp:TextBox ID="t2" class="form-control" runat="server"  placeholder="Recipie" ></asp:TextBox>
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                              <asp:Button ID="Button1" runat="server" OnClick="onClick" Text="Add Recipie"  class="btn btn-success btn-lg"></asp:Button>
                            </div>
                        </div>
